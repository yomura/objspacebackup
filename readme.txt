...
Tags: cloud, dreamhost, objspacebackup, backup
...
<em>Please <strong>do not</strong> open DreamHost Support Tickets for this plugin.</em> Honestly, the support techs are fantastic, but they can't debug this yet, so they'll just send you here anyway. Post in the <a href="http://wordpress.org/support/plugin/objspacebackup">support forum here</a>, and I'll get to you ASAP.
...
1. Sign up for <a href="http://dreamhost.com/cloud/objspacebackup/">ObjSpace</a>
...
* Zip has shorter paths (unzipped, it's /objspacebackup-backup/wp-content/etc)
...
* New wp-cli command: `wp objspacebackup resetlog` (resets the debug log)
...
* Moving OBJSPACEBACKUP::, messages, registering settings, and many other things to their own files.
...
* Forked <a href="http://wordpress.org/extend/plugins/wp-s3-backups/">WP S3 Backups</a> to work with ObjSpace.
